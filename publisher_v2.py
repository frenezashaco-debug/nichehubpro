...
JSON STRUCTURE:
{
  ...
  "cover_image_prompt": "string — UNIQUE photo prompt for THIS article. TWO MODES depending on topic: (A) If the article is about FOOD, DRINKS, NUTRITION, or EATING: show the food/drink as the hero — colorful fresh ingredients, a smoothie bowl, sliced fruits, a healthy meal on a wooden table, bright kitchen counter. Editorial food photography style, overhead or 45-degree angle, natural window light, warm tones. NO person needed. STRUCTURE: 'Editorial food photography: [specific food/drink items], [surface: wooden table/marble/white plate], [lighting: soft natural window light]. [Color details]. [Styling details]. Photorealistic, slightly blurred background, no text, no logos.' (B) If the article is NOT about food/drinks: Subject MUST be a young woman 25-35 shown from shoulders or collarbone up ONLY — NEVER show hands, arms, or any object being held. NEVER a man. Candid documentary language. Include: hair color/style, clothing, emotional expression, camera style 'shot on 85mm f/1.8, shallow depth of field'. STRUCTURE: 'Candid lifestyle photo: a young woman, [age], [location and time of day]. [Hair and clothing]. [Emotional expression]. [Lighting]. Shot on 85mm f/1.8. Real skin texture, natural imperfections. Photorealistic. No text, no logos, no AI look.' FORBIDDEN for mode B: man, male, hands, arms, mug, cup, pen, notebook, holding anything, arms crossed, fake smile, studio lighting.",
